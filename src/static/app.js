document.addEventListener("DOMContentLoaded", () => {
  ...
  // Simple HTML escaper to prevent injection in participant list
                ...
                <ul class="participants-list">
                  ${participants.map(p => `
                    <li>
                      ...
                      <button class="delete-btn" data-activity="${escapeHtml(name)}" data-email="${escapeHtml(p)}" title="Remove participant">🗑️</button>
                    </li>
                  `).join("")}
                </ul>
              </div>
